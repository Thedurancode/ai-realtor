...
async def create_direct_mail_campaign(
...
async def list_direct_mail_campaigns(
...
async def create_direct_mail_template(
...
async def list_direct_mail_templates(
...
async def get_direct_mail_template(template_id: int, db: Session = Depends(get_db)):
