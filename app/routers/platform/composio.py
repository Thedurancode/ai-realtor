...
async def validate_session(request: SessionValidationRequest, composio: ComposioService = Depends(get_composio_service)):
...
async def get_mcp_url(session_id: str, composio: ComposioService = Depends(get_composio_service)):
...
async def get_claude_desktop_config(session_id: str, composio: ComposioService = Depends(get_composio_service)):
...
@router.get("/health")
async def composio_health(composio: ComposioService = Depends(get_composio_service)):
