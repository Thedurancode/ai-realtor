...
async def generate_property_video(
    ...
    service: PropertyVideoService = Depends(get_property_video_service),
):
    """
...
@router.get("/voices")
async def list_available_voices(service: PropertyVideoService = Depends(get_property_video_service)):
    """
