...
def create_tts(req: TTSRequest, svc: ShotstackCreateService = Depends(get_shotstack_create_service)):
...
def create_avatar(req: AvatarRequest, svc: ShotstackCreateService = Depends(get_shotstack_create_service)):
...
def create_image(req: ImageRequest, svc: ShotstackCreateService = Depends(get_shotstack_create_service)):
...
def get_asset_status(asset_id: str, svc: ShotstackCreateService = Depends(get_shotstack_create_service)):
