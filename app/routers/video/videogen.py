...
from app.services.videogen_service import VideoGenService, get_videogen_service, generate_video_and_upload
...
async def list_videogen_avatars(
    agent_id: int,
    db: Session = Depends(get_db),
    service: VideoGenService = Depends(get_videogen_service),
):
...
async def get_videogen_video_status(
    video_id: str,
    agent_id: int,
    db: Session = Depends(get_db),
    service: VideoGenService = Depends(get_videogen_service),
...
async def create_videogen_template(
    template_name: str,
...
async def list_videogen_templates(
    agent_id: int,
