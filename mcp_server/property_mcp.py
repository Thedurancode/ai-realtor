...
async def list_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            name="create_offer",
            description="Make an offer on a property. Supports property ID or address. Voice: 'Make an offer of $400K on 123 Main St with 30-day close'.",
            inputSchema={
                "type": "object",
                "properties": {
                    ...
                    "offer_price": {"type": "number", "description": "Offer price in dollars (e.g., 400000)"},
                    "earnest_money": {"type": "number", "description": "Earnest money deposit in dollars"},
                    "financing_type": {"type": "string", "description": "Financing type: cash, conventional, fha, va, hard_money, seller_financing", "default": "cash"},
                    "closing_days": {"type": "number", "description": "Days to close from acceptance (default: 30)", "default": 30},
                    "contingencies": {"type": "array", "items": {"type": "string"}, "description": "List of contingencies: inspection, financing, appraisal, etc."},
                    "notes": {"type": "string", "description": "Additional terms or notes"},
                    "is_our_offer": {"type": "boolean", "description": "True if we're making the offer, false if we received it", "default": True},
                },
        ...
        Tool(
            name="counter_offer",
            description="Counter an existing offer with new terms. Voice: 'Counter at $380K with 45-day close'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "offer_id": {"type": "number", "description": "The offer ID to counter"},
                    "property_id": {"type": "number", "description": "Property ID (finds latest active offer)"},
                    "address": {"type": "string", "description": "Property address (finds latest active offer)"},
                    "offer_price": {"type": "number", "description": "Counter-offer price"},
                    "earnest_money": {"type": "number", "description": "Updated earnest money"},
                    "closing_days": {"type": "number", "description": "Updated days to close"},
                    "contingencies": {"type": "array", "items": {"type": "string"}, "description": "Updated contingencies"},
                    "notes": {"type": "string", "description": "Counter-offer notes"},
                },
                "required": ["offer_price"],
            }
        ),
        Tool(
            name="accept_offer",
            description="Accept an offer on a property. Auto-sets property to pending, rejects competing offers, and attaches purchase agreement. Voice: 'Accept the offer on property 5'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "offer_id": {"type": "number", "description": "Offer ID to accept"},
                    "property_id": {"type": "number", "description": "Property ID (accepts highest active offer)"},
                    "address": {"type": "string", "description": "Property address (accepts highest active offer)"},
                },
            }
        ),
        Tool(
            name="reject_offer",
            description="Reject an offer on a property. Voice: 'Reject the offer on Ocean Drive'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "offer_id": {"type": "number", "description": "Offer ID to reject"},
                    "property_id": {"type": "number", "description": "Property ID (rejects latest active offer)"},
                    "address": {"type": "string", "description": "Property address (rejects latest active offer)"},
                },
            }
        ),
        Tool(
            name="withdraw_offer",
            description="Withdraw our offer on a property. Voice: 'Withdraw my offer on 123 Main'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "offer_id": {"type": "number", "description": "Offer ID to withdraw"},
                    "property_id": {"type": "number", "description": "Property ID (withdraws our latest active offer)"},
        ...
        Tool(
            name="list_offers",
            description="List all offers, optionally filtered by property or status. Voice: 'What offers do we have?' or 'Show offers on property 5'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Filter by property ID"},
                    "address": {"type": "string", "description": "Filter by property address"},
                    "status": {"type": "string", "description": "Filter by status: submitted, countered, accepted, rejected, withdrawn, expired"},
                },
            }
        ),
        Tool(
            name="get_offer_details",
            description="Get detailed offer summary for a property including voice-friendly response. Voice: 'What's the offer status on 123 Main?'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Property ID"},
        ...
        Tool(
            name="calculate_mao",
            description="Calculate Maximum Allowable Offer based on underwriting data or Zestimate. Voice: 'What's the max I should offer on property 5?'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Property ID"},
        ...
        Tool(
            ...
            description="Search properties using natural language semantic search powered by AI embeddings. Voice: 'Find modern condos in Brooklyn with parking' or 'Search for houses under 500K near good schools'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "Natural language search query"},
                    "limit": {"type": "number", "description": "Max results (default 10)", "default": 10},
                    "status": {"type": "string", "description": "Filter by status: available, pending, sold"},
                    "property_type": {"type": "string", "description": "Filter by type: house, condo, apartment, townhouse, land, commercial"},
        ...
        Tool(
            ...
            description="Find properties similar to a given property using AI vector similarity. Voice: 'Find properties similar to property 5' or 'Show me listings like the one on Main Street'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Property ID to find similar properties for"},
                    "address": {"type": "string", "description": "Property address to find similar properties for"},
        ...
        Tool(
            ...
            description="Search across all research dossiers and evidence items using semantic search. Voice: 'Find research about flood zones in Miami' or 'What do we know about school ratings near Brooklyn?'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "query": {"type": "string", "description": "Natural language search query"},
                    "dossier_limit": {"type": "number", "description": "Max dossiers to return (default 5)", "default": 5},
                    "evidence_limit": {"type": "number", "description": "Max evidence items to return (default 10)", "default": 10},
                },
                "required": ["query"],
            }
        ),
        ...
        Tool(
            name="calculate_deal",
            description="Calculate deal metrics for a property across wholesale, flip, and rental strategies. Automatically pulls Zillow/underwriting data. Returns recommended strategy with offer price and profit. Voice: 'Calculate the deal for property 5' or 'Run deal numbers on the Brooklyn property with heavy rehab'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Property ID"},
                    "address": {"type": "string", "description": "Property address (alternative to property_id)"},
                    "rehab_tier": {"type": "string", "enum": ["light", "medium", "heavy"], "default": "medium", "description": "Rehab tier: light ($15/sqft), medium ($35/sqft), heavy ($60/sqft)"},
                    "arv_override": {"type": "number", "description": "Override ARV for what-if analysis"},
                    "monthly_rent_override": {"type": "number", "description": "Override monthly rent for what-if analysis"},
                },
            }
        ),
        Tool(
            name="compare_strategies",
            description="Compare wholesale, flip, and rental strategies side-by-side for a property. Shows offer price, profit, ROI, and cash flow for each. Voice: 'Compare strategies for property 5' or 'Compare wholesale vs flip for the Main Street property'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Property ID"},
        ...
        Tool(
            name="what_if_deal",
            description="Run a what-if scenario on a deal with custom assumptions. Voice: 'What if the ARV is 500 thousand on property 5?' or 'Recalculate property 3 with heavy rehab and 2000 rent'.",
            inputSchema={
                "type": "object",
                "properties": {
                    "property_id": {"type": "number", "description": "Property ID"},
                    "address": {"type": "string", "description": "Property address (alternative to property_id)"},
                    "arv_override": {"type": "number", "description": "Custom ARV value"},
                    "monthly_rent_override": {"type": "number", "description": "Custom monthly rent"},
                    "rehab_tier": {"type": "string", "enum": ["light", "medium", "heavy"], "description": "Rehab tier"},
                },
            }
        ),
    ]
...
async def call_tool(name: str, arguments: Any) -> list[TextContent]:
    ...
    try:
        ...
        # ── Offer & Negotiation Handlers ──
            ...
            # If no offer_id, find latest active offer for the property
            if not offer_id:
                property_id = arguments.get("property_id")
                address = arguments.get("address")
                if not property_id and address:
                    property_id = find_property_by_address(address)
                if property_id:
                    resp = requests.get(f"{API_BASE_URL}/offers/", params={"property_id": property_id, "status": "submitted"})
                    if resp.ok:
                        offers = resp.json()
                        if not offers:
                            resp2 = requests.get(f"{API_BASE_URL}/offers/", params={"property_id": property_id, "status": "countered"})
                            if resp2.ok:
                                offers = resp2.json()
                        if offers:
            ...
            response = requests.post(f"{API_BASE_URL}/offers/{offer_id}/counter", json=payload)
            response.raise_for_status()
            offer = response.json()
            ...
            if not offer_id:
                ...
                if not property_id and address:
                    property_id = find_property_by_address(address)
                if property_id:
                    # Accept the highest active offer
                    resp = requests.get(f"{API_BASE_URL}/offers/", params={"property_id": property_id})
                    if resp.ok:
            ...
            response = requests.post(f"{API_BASE_URL}/offers/{offer_id}/accept")
            response.raise_for_status()
            offer = response.json()
            ...
            response = requests.post(f"{API_BASE_URL}/offers/{offer_id}/reject")
            response.raise_for_status()
            offer = response.json()
            ...
            response = requests.post(f"{API_BASE_URL}/offers/{offer_id}/withdraw")
            response.raise_for_status()
            offer = response.json()
            ...
            response = requests.get(f"{API_BASE_URL}/offers/", params=params)
            response.raise_for_status()
            ...
            response = requests.get(f"{API_BASE_URL}/offers/property/{property_id}/summary")
            response.raise_for_status()
            ...
            response = requests.post(f"{API_BASE_URL}/offers/property/{property_id}/mao")
            response.raise_for_status()
            mao = response.json()
        ...
        # ── Vector Search Handlers ────────────────────────────────
            ...
            response = requests.post(f"{API_BASE_URL}/search/properties", json=payload)
            response.raise_for_status()
            data = response.json()
        ...
        elif name == "find_similar_properties":
            property_id = arguments.get("property_id")
            address = arguments.get("address")
            if not property_id and address:
                property_id = find_property_by_address(address)
            ...
            response = requests.get(f"{API_BASE_URL}/search/similar/{property_id}", params={"limit": limit})
            response.raise_for_status()
            data = response.json()
            ...
            response = requests.post(f"{API_BASE_URL}/search/research", json=payload)
            response.raise_for_status()
            data = response.json()
        ...
        # ── Deal Calculator Handlers ─────────────────────────────
        elif name == "calculate_deal":
            property_id = arguments.get("property_id")
            address = arguments.get("address")
            if not property_id and address:
                property_id = find_property_by_address(address)
            ...
            response = requests.post(f"{API_BASE_URL}/deal-calculator/voice", params=params)
            response.raise_for_status()
            data = response.json()
            ...
            # Helper to format a strategy block
            ...
            response = requests.get(f"{API_BASE_URL}/deal-calculator/property/{property_id}")
            response.raise_for_status()
            data = response.json()
            ...
            response = requests.post(f"{API_BASE_URL}/deal-calculator/calculate", json=payload)
            response.raise_for_status()
            data = response.json()
