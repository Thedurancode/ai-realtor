...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("\nUsage:")
        print("  python3 property_tools.py create <address> <city> <state> <zip> <price> [options]")
        print("  python3 property_tools.py list")
        print("  python3 property_tools.py get <property_id>")
        print("  python3 property_tools.py update <property_id> <field> <value>")
        print("  python3 property_tools.py delete <property_id>")
        print("  python3 property_tools.py search <query>")
        print("\nExamples:")
        print('  python3 property_tools.py create "123 Main St" "New York" "NY" "10001" 500000')
        print('  python3 property_tools.py list')
        print('  python3 property_tools.py get 1')
        print('  python3 property_tools.py update 1 price 550000')
        print('  python3 property_tools.py delete 1')
        print('  python3 property_tools.py search "broadway"')
        sys.exit(1)
