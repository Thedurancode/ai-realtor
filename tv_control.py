...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python3 tv_control.py show <address>")
        print("  python3 tv_control.py show_id <property_id>")
        print("  python3 tv_control.py speak <message>")
        print("  python3 tv_control.py close")
        sys.exit(1)
